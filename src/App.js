...
const initialFriends = [
  {
    ...
    name: "Alisher",
    image:
      "https://bimmereuro.com/cdn/shop/products/g30hood3.png?v=1675488568&width=2048",
    balance: -7,
  },
  {
    id: 933372,
    ...
    <div className="app">
      <div className="sidebar">
        ...
        <Button onClick={handleShowAddFriend}>
          {showAddFriend ? "Yopish" : "Do'st qo'shish"}
        </Button>
      </div>
...
function Friend({ friend, onSelection, selectedFriend }) {
  ...
  return (
    <li className={isSelected ? "selected" : ""}>
      ...
      {friend.balance === 0 && <p>Siz va {friend.name} rachchotsilar.</p>}
...
function FormAddFriend({ onAddFriend }) {
  ...
  return (
    <form className="form-add-friend" onSubmit={handleSubmit}>
      <label htmlFor="">🧑 Do'sting ismi</label>
      <input
        type="text"
        value={name}
      ...
      <label htmlFor="">📰 Do'sting rasmi</label>
      <input
        type="text"
        value={image}
